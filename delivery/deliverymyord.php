...
// Fix: Use null coalescing operator to prevent undefined key warnings
$name = $_SESSION['name'] ?? '';
$id = $_SESSION['Did'] ?? null; // Set to null if 'Did' is not present

// Optional: If 'Did' is required, redirect user
if ($id === null) {
    header("location:deliverylogin.php"); 
    exit();
}
